...
## [v0.75.8](https://github.com/k1LoW/octocov/compare/v0.75.7...v0.75.8) - 2026-04-26
### Other Changes
...
## [v0.74.6](https://github.com/k1LoW/octocov/compare/v0.74.5...v0.74.6) - 2026-02-26
### Other Changes
- chore(deps): bump the dependencies group across 1 directory with 9 updates by @dependabot[bot] in https://github.com/k1LoW/octocov/pull/623
- chore(deps): bump github.com/cloudflare/circl from 1.6.1 to 1.6.3 by @dependabot[bot] in https://github.com/k1LoW/octocov/pull/624
- chore(deps): bump the dependencies group across 1 directory with 4 updates by @dependabot[bot] in https://github.com/k1LoW/octocov/pull/622
...
- chore(deps): bump the dependencies group with 5 updates by @dependabot[bot] in https://github.com/k1LoW/octocov/pull/610
- chore(deps): bump the dependencies group with 2 updates by @dependabot[bot] in https://github.com/k1LoW/octocov/pull/609
- fix: replace deprecated option.WithCredentialsJSON with credentials.DetectDefault by @k1LoW in https://github.com/k1LoW/octocov/pull/611
- docs: simplify coverage merging example using test sharding by @k1LoW in https://github.com/k1LoW/octocov/pull/612
...
### Other Changes
- chore(deps): bump the dependencies group across 1 directory with 13 updates by @dependabot[bot] in https://github.com/k1LoW/octocov/pull/601
- chore(deps): bump the dependencies group across 1 directory with 3 updates by @dependabot[bot] in https://github.com/k1LoW/octocov/pull/600
- chore(deps): bump the dependencies group with 5 updates by @dependabot[bot] in https://github.com/k1LoW/octocov/pull/603
- chore(deps): bump the dependencies group with 2 updates by @dependabot[bot] in https://github.com/k1LoW/octocov/pull/604
