...
// against 0.93 s over these seventeen. Which languages the page colours is this list, and
...
function forPage() {
  ...
  return (code, filename) => {
    ...
    highlighter ??= createPageHighlighter({
      langs: [
        bash, c, cpp, csharp, go, java, javascript, json, jsx, markdown, python, ruby, rust,
